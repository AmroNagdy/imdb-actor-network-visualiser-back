...
def update_with_basic_actor_details(movie_details: Dict[str, Any]) -> None:
    ...
    # Transform list of nconsts in the actors_key in the movie_and_actor_details to basic actor details.
    for _, details in movie_details.items():
...
with open(output_file_name, 'w') as output_file:
    ...
    print(f'Successfully written movie_and_actor_details as JSON to {output_file_name}.')
